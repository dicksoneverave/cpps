    ...
    const checkRole = async () => {
      try {
        if (!loading) {
          ...
          if (storedRole && !storedRole.toLowerCase().includes('payment')) {
            console.log("User doesn't have Payment role, redirecting to appropriate dashboard");
